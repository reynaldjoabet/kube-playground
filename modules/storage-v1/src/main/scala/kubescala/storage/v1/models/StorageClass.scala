...
case class StorageClass(
  ...
  @named("allowVolumeExpansion") allowVolumeExpansion: Option[Boolean] = scala.None,
  /* allowedTopologies restrict the node topologies where volumes can be dynamically provisioned. Each volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is only honored by servers that enable the VolumeScheduling feature. */
  @named("allowedTopologies") allowedTopologies: Option[Seq[TopologySelectorTerm]] = scala.None,
  ...
  @named("reclaimPolicy") reclaimPolicy: Option[StorageClassEnums.ReclaimPolicy] = scala.None,
  ...
  @named("volumeBindingMode") volumeBindingMode: Option[StorageClassEnums.VolumeBindingMode] = scala.None
)
...
object StorageClassEnums:
  ...
  object ReclaimPolicy:
    ...
    given reclaimPolicyCodec: JsonValueCodec[ReclaimPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
  ...
  object VolumeBindingMode:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given volumeBindingModeCodec: JsonValueCodec[VolumeBindingMode] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
