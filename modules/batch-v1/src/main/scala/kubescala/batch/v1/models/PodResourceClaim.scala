...
/** PodResourceClaim references exactly one ResourceClaim, either directly or by
  ...
  * the pod. It adds a name to it that uniquely identifies the ResourceClaim
  * inside the Pod. Containers that need access to the ResourceClaim reference
  * it with this name.
  */
case class PodResourceClaim(
    ...
    @named("resourceClaimTemplateName") resourceClaimTemplateName: Option[
      String
    ] = scala.None
)
