...
case class PodCertificateProjection(
  ...
  @named("certificateChainPath") certificateChainPath: Option[String] = scala.None,
  ...
  @named("credentialBundlePath") credentialBundlePath: Option[String] = scala.None,
  ...
  @named("maxExpirationSeconds") maxExpirationSeconds: Option[Int] = scala.None
)
