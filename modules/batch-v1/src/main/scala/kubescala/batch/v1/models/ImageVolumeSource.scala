...
case class ImageVolumeSource(
    ...
    @named("pullPolicy") pullPolicy: Option[ImageVolumeSourceEnums.PullPolicy] =
      scala.None,
...
object ImageVolumeSourceEnums:
  ...
  object PullPolicy:
    ...
    given pullPolicyCodec: JsonValueCodec[PullPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
