...
case class VolumeMount(
  ...
  @named("mountPropagation") mountPropagation: Option[VolumeMountEnums.MountPropagation] = scala.None,
...
object VolumeMountEnums:
  ...
  object MountPropagation:
    ...
    given mountPropagationCodec: JsonValueCodec[MountPropagation] = JsonCodecMaker.make {
      CodecMakerConfig
