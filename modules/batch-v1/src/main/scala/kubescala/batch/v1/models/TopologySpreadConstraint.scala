...
case class TopologySpreadConstraint(
  ...
  @named("whenUnsatisfiable") whenUnsatisfiable: TopologySpreadConstraintEnums.WhenUnsatisfiable,
  ...
  @named("matchLabelKeys") matchLabelKeys: Option[Seq[String]] = scala.None,
  ...
  @named("minDomains") minDomains: Option[Int] = scala.None,
  ...
  @named("nodeAffinityPolicy") nodeAffinityPolicy: Option[TopologySpreadConstraintEnums.NodeAffinityPolicy] = scala.None,
  ...
  @named("nodeTaintsPolicy") nodeTaintsPolicy: Option[TopologySpreadConstraintEnums.NodeTaintsPolicy] = scala.None
)

object TopologySpreadConstraintEnums:
  ...
  object WhenUnsatisfiable:
    ...
    given whenUnsatisfiableCodec: JsonValueCodec[WhenUnsatisfiable] = JsonCodecMaker.make {
      CodecMakerConfig
  ...
  object NodeAffinityPolicy:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given nodeAffinityPolicyCodec: JsonValueCodec[NodeAffinityPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
            case "Honor" => "Honor"
  ...
  object NodeTaintsPolicy:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given nodeTaintsPolicyCodec: JsonValueCodec[NodeTaintsPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
            case "Honor" => "Honor"
...
end TopologySpreadConstraintEnums
