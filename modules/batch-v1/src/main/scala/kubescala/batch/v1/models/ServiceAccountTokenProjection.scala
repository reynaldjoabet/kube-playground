...
import com.github.plokhotnyuk.jsoniter_scala.macros.named
  ...
  /**
   * ServiceAccountTokenProjection represents a projected ServiceAccount token volume. This projection can be used to insert a ServiceAccount token into the pods runtime filesystem for use against APIs (Kubernetes API Server or otherwise).
   */
