...
case class JobStatus(
  ...
  @named("completionTime") completionTime: Option[OffsetDateTime] = scala.None,
  ...
  @named("uncountedTerminatedPods") uncountedTerminatedPods: Option[UncountedTerminatedPods] = scala.None
)
