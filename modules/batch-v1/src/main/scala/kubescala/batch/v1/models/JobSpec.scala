...
case class JobSpec(
    ...
    @named("backoffLimitPerIndex") backoffLimitPerIndex: Option[Int] =
      scala.None,
    ...
    @named("completionMode") completionMode: Option[
      JobSpecEnums.CompletionMode
    ] = scala.None,
    ...
    @named("podFailurePolicy") podFailurePolicy: Option[PodFailurePolicy] =
      scala.None,
    ...
    @named("podReplacementPolicy") podReplacementPolicy: Option[
      JobSpecEnums.PodReplacementPolicy
    ] = scala.None,
    ...
    @named("ttlSecondsAfterFinished") ttlSecondsAfterFinished: Option[Int] =
      scala.None
)
...
object JobSpecEnums:
  ...
  object CompletionMode:
    ...
    given completionModeCodec: JsonValueCodec[CompletionMode] =
      JsonCodecMaker.make {
        CodecMakerConfig
  ...
  object PodReplacementPolicy:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given podReplacementPolicyCodec: JsonValueCodec[PodReplacementPolicy] =
      JsonCodecMaker.make {
        CodecMakerConfig
          .withAdtLeafClassNameMapper { x =>
            JsonCodecMaker.simpleClassName(x) match
