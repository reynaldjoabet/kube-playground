...
case class JobSpec(
  ...
  @named("backoffLimit") backoffLimit: Option[Int] = scala.None,
  /* Specifies the limit for the number of retries within an index before marking this index as failed. When enabled the number of failures per index is kept in the pod's batch.kubernetes.io/job-index-failure-count annotation. It can only be set when Job's completionMode=Indexed, and the Pod's restart policy is Never. The field is immutable. */
  @named("backoffLimitPerIndex") backoffLimitPerIndex: Option[Int] = scala.None,
  ...
  @named("completionMode") completionMode: Option[JobSpecEnums.CompletionMode] = scala.None,
  /* Specifies the desired number of successfully finished pods the job should be run with.  Setting to null means that the success of any pod signals the success of all pods, and allows parallelism to have any positive value.  Setting to 1 means that parallelism is limited to 1 and the success of that pod signals the success of the job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/ */
  @named("completions") completions: Option[Int] = scala.None,
  ...
  @named("managedBy") managedBy: Option[String] = scala.None,
  ...
  @named("podReplacementPolicy") podReplacementPolicy: Option[JobSpecEnums.PodReplacementPolicy] = scala.None,
  ...
  @named("successPolicy") successPolicy: Option[SuccessPolicy] = scala.None,
  ...
  @named("ttlSecondsAfterFinished") ttlSecondsAfterFinished: Option[Int] = scala.None
)
...
object JobSpecEnums:
  ...
  object CompletionMode:
    ...
    given completionModeCodec: JsonValueCodec[CompletionMode] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
            case "Indexed" => "Indexed"
            case "NonIndexed" => "NonIndexed"
        }
  ...
  object PodReplacementPolicy:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given podReplacementPolicyCodec: JsonValueCodec[PodReplacementPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
            case "Failed" => "Failed"
            case "TerminatingOrFailed" => "TerminatingOrFailed"
        }
        .withDiscriminatorFieldName(scala.None)
    }
end JobSpecEnums
