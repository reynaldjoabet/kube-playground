...
------------ | ------------- | ------------- | -------------
*AuthenticationV1Api* | **createAuthenticationV1SelfSubjectReview** | **POST** /apis/authentication.k8s.io/v1/selfsubjectreviews | 
*AuthenticationV1Api* | **createAuthenticationV1TokenReview** | **POST** /apis/authentication.k8s.io/v1/tokenreviews | 
*AuthenticationV1Api* | **getAuthenticationV1APIResources** | **GET** /apis/authentication.k8s.io/v1/ | 
