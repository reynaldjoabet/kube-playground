...
case class PodDisruptionBudgetSpec(
  ...
  @named("unhealthyPodEvictionPolicy") unhealthyPodEvictionPolicy: Option[PodDisruptionBudgetSpecEnums.UnhealthyPodEvictionPolicy] = scala.None
)
...
object PodDisruptionBudgetSpecEnums:
  ...
  object UnhealthyPodEvictionPolicy:
    ...
    given unhealthyPodEvictionPolicyCodec: JsonValueCodec[UnhealthyPodEvictionPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
