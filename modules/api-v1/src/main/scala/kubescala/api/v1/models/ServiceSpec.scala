...
case class ServiceSpec(
  ...
  @named("allocateLoadBalancerNodePorts") allocateLoadBalancerNodePorts: Option[Boolean] = scala.None,
  ...
  @named("clusterIP") clusterIP: Option[String] = scala.None,
  ...
  @named("clusterIPs") clusterIPs: Option[Seq[String]] = scala.None,
  /* externalIPs is a list of IP addresses for which nodes in the cluster will also accept traffic for this service.  These IPs are not managed by Kubernetes.  The user is responsible for ensuring that traffic arrives at a node with this IP.  A common example is external load-balancers that are not part of the Kubernetes system. */
  @named("externalIPs") externalIPs: Option[Seq[String]] = scala.None,
  /* externalName is the external reference that discovery mechanisms will return as an alias for this service (e.g. a DNS CNAME record). No proxying will be involved.  Must be a lowercase RFC-1123 hostname (https://tools.ietf.org/html/rfc1123) and requires `type` to be \"ExternalName\". */
  @named("externalName") externalName: Option[String] = scala.None,
  ...
  @named("externalTrafficPolicy") externalTrafficPolicy: Option[ServiceSpecEnums.ExternalTrafficPolicy] = scala.None,
  ...
  @named("healthCheckNodePort") healthCheckNodePort: Option[Int] = scala.None,
  ...
  @named("internalTrafficPolicy") internalTrafficPolicy: Option[ServiceSpecEnums.InternalTrafficPolicy] = scala.None,
  ...
  @named("ipFamilies") ipFamilies: Option[Seq[ServiceSpecEnums.IpFamilies]] = scala.None,
  ...
  @named("ipFamilyPolicy") ipFamilyPolicy: Option[ServiceSpecEnums.IpFamilyPolicy] = scala.None,
  ...
  @named("loadBalancerClass") loadBalancerClass: Option[String] = scala.None,
  /* Only applies to Service Type: LoadBalancer. This feature depends on whether the underlying cloud-provider supports specifying the loadBalancerIP when a load balancer is created. This field will be ignored if the cloud-provider does not support the feature. Deprecated: This field was under-specified and its meaning varies across implementations. Using it is non-portable and it may not support dual-stack. Users are encouraged to use implementation-specific annotations when available. */
  @named("loadBalancerIP") loadBalancerIP: Option[String] = scala.None,
  /* If specified and supported by the platform, this will restrict traffic through the cloud-provider load-balancer will be restricted to the specified client IPs. This field will be ignored if the cloud-provider does not support the feature.\" More info: https://kubernetes.io/docs/tasks/access-application-cluster/create-external-load-balancer/ */
  @named("loadBalancerSourceRanges") loadBalancerSourceRanges: Option[Seq[String]] = scala.None,
  /* The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies */
  @named("ports") ports: Option[Seq[ServicePort]] = scala.None,
  ...
  @named("publishNotReadyAddresses") publishNotReadyAddresses: Option[Boolean] = scala.None,
  ...
  @named("sessionAffinity") sessionAffinity: Option[ServiceSpecEnums.SessionAffinity] = scala.None,
  /* sessionAffinityConfig contains the configurations of session affinity. */
  @named("sessionAffinityConfig") sessionAffinityConfig: Option[SessionAffinityConfig] = scala.None,
  /* TrafficDistribution offers a way to express preferences for how traffic is distributed to Service endpoints. Implementations can use this field as a hint, but are not required to guarantee strict adherence. If the field is not set, the implementation will apply its default routing strategy. If set to \"PreferClose\", implementations should prioritize endpoints that are in the same zone. */
  @named("trafficDistribution") trafficDistribution: Option[String] = scala.None,
  ...
  @named("type") `type`: Option[ServiceSpecEnums.Type] = scala.None
)

object ServiceSpecEnums:
  ...
  object ExternalTrafficPolicy:
    ...
    given externalTrafficPolicyCodec: JsonValueCodec[ExternalTrafficPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
  ...
  object InternalTrafficPolicy:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given internalTrafficPolicyCodec: JsonValueCodec[InternalTrafficPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
            case "Cluster" => "Cluster"
  ...
  object IpFamilyPolicy:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given ipFamilyPolicyCodec: JsonValueCodec[IpFamilyPolicy] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
            case "PreferDualStack" => "PreferDualStack"
            case "RequireDualStack" => "RequireDualStack"
  ...
  object SessionAffinity:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given sessionAffinityCodec: JsonValueCodec[SessionAffinity] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
