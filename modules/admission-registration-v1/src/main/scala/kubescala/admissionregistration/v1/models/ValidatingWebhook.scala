...
case class ValidatingWebhook(
  ...
  @named("sideEffects") sideEffects: ValidatingWebhookEnums.SideEffects,
  ...
  @named("failurePolicy") failurePolicy: Option[ValidatingWebhookEnums.FailurePolicy] = scala.None,
  ...
  @named("matchPolicy") matchPolicy: Option[ValidatingWebhookEnums.MatchPolicy] = scala.None,
