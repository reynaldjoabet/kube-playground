...
case class MutatingWebhook(
  ...
  @named("admissionReviewVersions") admissionReviewVersions: Seq[String],
  /* ClientConfig defines how to communicate with the hook. Required */
  @named("clientConfig") clientConfig: WebhookClientConfig,
  ...
  @named("sideEffects") sideEffects: MutatingWebhookEnums.SideEffects,
  ...
  @named("failurePolicy") failurePolicy: Option[MutatingWebhookEnums.FailurePolicy] = scala.None,
  ...
  @named("matchConditions") matchConditions: Option[Seq[MatchCondition]] = scala.None,
  ...
  @named("matchPolicy") matchPolicy: Option[MutatingWebhookEnums.MatchPolicy] = scala.None,
  ...
  @named("namespaceSelector") namespaceSelector: Option[LabelSelector] = scala.None,
...
object MutatingWebhookEnums:
  ...
  object SideEffects:
    ...
    given sideEffectsCodec: JsonValueCodec[SideEffects] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
            case "None" => "None"
            case "NoneOnDryRun" => "NoneOnDryRun"
            case "Some" => "Some"
  ...
  object FailurePolicy:
    import com.github.plokhotnyuk.jsoniter_scala.macros.*
    import com.github.plokhotnyuk.jsoniter_scala.core.*
    given failurePolicyCodec: JsonValueCodec[FailurePolicy] = JsonCodecMaker.make {
      CodecMakerConfig
        .withAdtLeafClassNameMapper { x =>
          JsonCodecMaker.simpleClassName(x) match
            case "Fail" => "Fail"
