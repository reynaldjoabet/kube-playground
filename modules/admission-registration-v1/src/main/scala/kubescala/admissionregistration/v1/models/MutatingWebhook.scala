...
case class MutatingWebhook(
    ...
    @named("failurePolicy") failurePolicy: Option[
      MutatingWebhookEnums.FailurePolicy
    ] = scala.None,
    ...
    @named("matchPolicy") matchPolicy: Option[
      MutatingWebhookEnums.MatchPolicy
    ] = scala.None,
    ...
    @named("reinvocationPolicy") reinvocationPolicy: Option[String] =
      scala.None,
