...
case class HTTPIngressPath(
    ...
    @named("backend") backend: IngressBackend,
...
object HTTPIngressPathEnums:
  ...
  object PathType:
    ...
    given pathTypeCodec: JsonValueCodec[PathType] = JsonCodecMaker.make {
      CodecMakerConfig
